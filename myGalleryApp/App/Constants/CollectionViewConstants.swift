...
struct CollectionViewConstants {
    ...
    static let contentInset = UIEdgeInsets.init(top: 10, left: 16, bottom: 10, right: 16)
    
    static func calcLayout(frameWidth: CGFloat) -> CGSize {
        let itemWidth = ((frameWidth - (CollectionViewConstants.horizontalInset * 2 ) - CollectionViewConstants.spaceBetweenElements)/2)
